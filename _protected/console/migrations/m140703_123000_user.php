...
class m140703_123000_user extends Migration
{
    public function up()
    {
        ...
        $this->insert('{{%user}}', [
            ...
            'created_at'=>time(),
            'updated_at'=>time(),
            'access_token'=> md5("webmaster".Yii::$app->getSecurity()->generatePasswordHash('webmaster')),
        ]);
        $this->insert('{{%user}}', [
            'id'=>2,
            'username'=>'manager',
            ...
            'created_at'=>time(),
            'updated_at'=>time(),
            'access_token'=> md5("manager".Yii::$app->getSecurity()->generatePasswordHash('manager')),
        ]);
        $this->insert('{{%user}}', [
            'id'=>3,
            'username'=>'user',
            ...
            'created_at'=>time(),
            'updated_at'=>time(),
            'access_token'=> md5("user".Yii::$app->getSecurity()->generatePasswordHash('user')),
        ]);
