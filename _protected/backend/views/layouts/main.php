                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header bg-light-blue">
                            <img src="<?= Yii::$app->user->identity->profile->getFileUrl("picture") ?: \yii\helpers\Url::to('@backendUrl/img/anonymous.jpg') ?>" class="img-circle" alt="User Image" />
                            <p>
            ...
            <?= backend\components\widgets\Menu::widget([
                ...
                'items'=>[
                    ...
                    [
                        ...
                        'items'=>[
                            ['label' => Yii::t('backend', 'Content1'), 'url' => ['/content1/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Content2'), 'url' => ['/content2/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                        ]
                    ],
                    [
