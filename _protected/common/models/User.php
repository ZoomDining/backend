...
*/
    ...
    {
        // if password changed, save password_hash
        if($insert || isset($changedAttributes["password_hash"])){
            $access_token = md5($this->username.$this->_password);
            static::updateAll(["access_token" => $access_token], "id=".$this->id);
        }
